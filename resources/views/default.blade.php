...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="{{route('articles.index')}}">Start Bootstrap</a>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url(@yield('image','/img/home-bg.jpg'))">
  ...
  <footer>
    ...
    <form action="{{route('newsletter.store')}}" method="POST" class="form-inline justify-content-center">
        @csrf
